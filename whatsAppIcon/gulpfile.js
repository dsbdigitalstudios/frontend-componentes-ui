...
function bootstrap() {
    return gulp
        .src('custom/terceiros/bootstrap_4-custom/bootstrap-custom.scss')
        //.pipe(sourcemaps.init())
        .pipe(sass())
        .on("error", sass.logError)
        .pipe(postcss([autoprefixer(), cssnano()]))
...
function grid() {
    return gulp
        .src('custom/terceiros/bootstrap_4-custom/bootstrap-grid.scss')
        //.pipe(sourcemaps.init())
        .pipe(sass())
        .on("error", sass.logError)
        .pipe(postcss([autoprefixer(), cssnano()]))
...
function reboot() {
    return gulp
        .src('custom/terceiros/bootstrap_4-custom/bootstrap-reboot.scss')
        //.pipe(sourcemaps.init())
        .pipe(sass())
        .on("error", sass.logError)
        .pipe(postcss([autoprefixer(), cssnano()]))
...
function caroucel() {
    return gulp
        .src('custom/terceiros/owl-carousel/owl.carousel.scss')
        //.pipe(sourcemaps.init())
        .pipe(sass())
        .on("error", sass.logError)
        .pipe(postcss([autoprefixer(), cssnano()]))
